...
enum {E_PG_MAIN,E_PG_WIFI,E_PG_WIFI_PSWD,E_PG_OVERVIEW,E_PG_INFO
      ,E_PG_SYSTEM_SETTINGS,E_PG_IOT_SETTINGS,E_PG_POPUP_DIMMER
      ,E_POP_KEYPAD_NUM,E_POP_KEYPAD_ALPHA};
enum {E_DRAW_LINE1,E_DRAW_LINE3,E_DRAW_LINE4,E_DRAW_LINE5,E_DRAW_LINE6
      ,E_DRAW_LINE8,E_ELEM_AQI,E_ELEM_BACK34,E_ELEM_BACK37
      ,E_ELEM_BACK38,E_ELEM_BTN_BACK_PG_WIFI
      ,E_ELEM_BTN_BACK_PG_WIFI_PWD,E_ELEM_BTN_CONNECT,E_ELEM_BTN_INFO
      ,E_ELEM_BTN_IOT_SETTINGS,E_ELEM_BTN_SCAN_WIFI
      ,E_ELEM_BTN_SYSTEM_SETTINGS,E_ELEM_BTN_WIFI_CONNECT
      ...
      ,E_ELEM_ENABLE_DIMMER,E_ELEM_HOME_BTN,E_ELEM_HUM_VALUE
      ,E_ELEM_IMAGE6,E_ELEM_IMAGE8,E_ELEM_IMG_NOWIFI,E_ELEM_IMG_WIFI
      ,E_ELEM_INFOBOX,E_ELEM_LABEL_SSID_PG_WIFI
      ,E_ELEM_LABEL_SSID_PG_WIFI_PWD,E_ELEM_MEASURE_BTN
      ,E_ELEM_MEAS_INTERVAL,E_ELEM_PM10_VALUE,E_ELEM_PM25_VALUE
      ,E_ELEM_PRINT_DATA,E_ELEM_PROGRESS_MEASURE,E_ELEM_PSWD_INPUT
      ,E_ELEM_RINGGAUGE_PM10,E_ELEM_RINGGAUGE_PM25,E_ELEM_TEMP_VALUE
      ,E_ELEM_TEXT33,E_ELEM_TEXT34,E_ELEM_TEXT36,E_ELEM_TEXT37
      ,E_ELEM_TEXT39,E_ELEM_TEXT41,E_ELEM_TEXT42,E_ELEM_TEXT43
      ,E_ELEM_TEXT44,E_ELEM_TEXT45,E_ELEM_TEXTPM25,E_ELEM_TEXT_AQI
      ...
      ,E_ELEM_TITEL_PG_WIFI,E_ELEM_TITEL_PG_WIFI_PWD,E_ELEM_TITLE_INFO
...
#define MAX_ELEM_PG_SYSTEM_SETTINGS 13 // # Elems total on page
#define MAX_ELEM_PG_SYSTEM_SETTINGS_RAM MAX_ELEM_PG_SYSTEM_SETTINGS // # Elems in RAM

#define MAX_ELEM_PG_IOT_SETTINGS 7 // # Elems total on page
#define MAX_ELEM_PG_IOT_SETTINGS_RAM MAX_ELEM_PG_IOT_SETTINGS // # Elems in RAM
...
gslc_tsElem                     m_asPage6Elem[MAX_ELEM_PG_SYSTEM_SETTINGS_RAM];
gslc_tsElemRef                  m_asPage6ElemRef[MAX_ELEM_PG_SYSTEM_SETTINGS];
gslc_tsElem                     m_asPage7Elem[MAX_ELEM_PG_IOT_SETTINGS_RAM];
gslc_tsElemRef                  m_asPage7ElemRef[MAX_ELEM_PG_IOT_SETTINGS];
...
char                            m_acTextboxBuf1[600]; // NRows=10 NCols=60
...
extern gslc_tsElemRef* m_pElem_INFO_BOX;
...
extern gslc_tsElemRef* m_pElem_btn_back_main_34;
extern gslc_tsElemRef* m_pElem_btn_back_main_37;
extern gslc_tsElemRef* m_pElem_btn_back_main_38;
...
extern gslc_tsElemRef* m_pElem_enable_dimmer;
...
extern gslc_tsElemRef* m_pElem_label_measure_art38_39_43;
...
//<InitGUI !Start!>
  ...
  gslc_PageAdd(&m_gui,E_PG_SYSTEM_SETTINGS,m_asPage6Elem,MAX_ELEM_PG_SYSTEM_SETTINGS_RAM,m_asPage6ElemRef,MAX_ELEM_PG_SYSTEM_SETTINGS);
  gslc_PageAdd(&m_gui,E_PG_IOT_SETTINGS,m_asPage7Elem,MAX_ELEM_PG_IOT_SETTINGS_RAM,m_asPage7ElemRef,MAX_ELEM_PG_IOT_SETTINGS);
  ...
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_INFOBOX,E_PG_INFO,&m_sTextbox1,
    (gslc_tsRect){10,40,300,80},E_BUILTIN5X8,
    (char*)&m_acTextboxBuf1,10,60);
  ...
  m_pElem_INFO_BOX = pElemRef;
  
  // Create E_ELEM_TITLE_INFO text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TITLE_INFO,E_PG_INFO,(gslc_tsRect){0,0,320,20},
    (char*)"Info",0,E_FREESANSBOLD12);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // create E_ELEM_BTN_SYSTEM_SETTINGS button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN_SYSTEM_SETTINGS,E_PG_INFO,
    (gslc_tsRect){45,185,95,24},(char*)"System",0,E_FREESANS9,&CbBtnCommon);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_GRAY_DK3,GSLC_COL_BLUE_LT4,GSLC_COL_GRAY_DK1);
  gslc_ElemSetRoundEn(&m_gui, pElemRef, true);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,false);
  
  // create E_ELEM_BTN_IOT_SETTINGS button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN_IOT_SETTINGS,E_PG_INFO,
    (gslc_tsRect){180,185,95,24},(char*)"IoT",0,E_FREESANS9,&CbBtnCommon);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_GRAY_DK3,GSLC_COL_BLUE_LT4,GSLC_COL_GRAY_DK1);
  gslc_ElemSetRoundEn(&m_gui, pElemRef, true);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,false);
  
  // Create E_ELEM_TEXT33 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT33,E_PG_INFO,(gslc_tsRect){0,140,320,30},
  ...
  pElemRef = gslc_ElemCreateLine(&m_gui,E_DRAW_LINE4,E_PG_INFO,45,174,275,174);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLACK,GSLC_COL_GRAY_LT2,GSLC_COL_GRAY_LT2);
  
  // Create E_ELEM_BACK34 button with image label
  pElemRef = gslc_ElemCreateBtnImg(&m_gui,E_ELEM_BACK34,E_PG_INFO,(gslc_tsRect){2,205,32,32},
          gslc_GetImageFromFile(IMG_EXIT,GSLC_IMGREF_FMT_BMP24),
          gslc_GetImageFromFile(IMG_EXIT,GSLC_IMGREF_FMT_BMP24),
          &CbBtnCommon);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  m_pElem_btn_back_main_34 = pElemRef;

  // -----------------------------------
  // PAGE: E_PG_SYSTEM_SETTINGS
  
  
  // Create E_ELEM_TEXT34 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT34,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){0,0,320,30},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_DIMMER_TIMER,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){130,60,27,15},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT36,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){10,30,124,23},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT37,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){160,60,25,15},
    (char*)"sec.",0,E_BUILTIN5X8);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_BOT_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create toggle button E_ELEM_ENABLE_DIMMER
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,E_ELEM_ENABLE_DIMMER,E_PG_SYSTEM_SETTINGS,&m_asXToggle3,
    (gslc_tsRect){18,60,45,18},GSLC_COL_GRAY,GSLC_COL_GREEN_DK1,GSLC_COL_GRAY_LT2,
    true,false,&CbBtnCommon);
  m_pElem_enable_dimmer = pElemRef;
  
  // Create E_ELEM_TEXT39 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT39,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){90,60,37,15},
  ...
  pElemRef = gslc_ElemCreateLine(&m_gui,E_DRAW_LINE5,E_PG_SYSTEM_SETTINGS,10,55,240,55);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLACK,GSLC_COL_GRAY_LT2,GSLC_COL_GRAY_LT2);
  
  // create E_ELEM_DIM_ON button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_DIM_ON,E_PG_SYSTEM_SETTINGS,
    (gslc_tsRect){210,60,60,18},(char*)"Dim now",0,E_BUILTIN5X8,&CbBtnCommon);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_GRAY_DK3,GSLC_COL_BLUE_LT4,GSLC_COL_GRAY_DK1);
  gslc_ElemSetRoundEn(&m_gui, pElemRef, true);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,false);
  
  // Create E_ELEM_BACK37 button with image label
  pElemRef = gslc_ElemCreateBtnImg(&m_gui,E_ELEM_BACK37,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){2,205,32,32},
          gslc_GetImageFromFile(IMG_EXIT,GSLC_IMGREF_FMT_BMP24),
          gslc_GetImageFromFile(IMG_EXIT,GSLC_IMGREF_FMT_BMP24),
          &CbBtnCommon);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  m_pElem_btn_back_main_37 = pElemRef;
  
  // Create E_ELEM_TEXT45 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT45,E_PG_SYSTEM_SETTINGS,(gslc_tsRect){10,100,153,23},
  ...
  pElemRef = gslc_ElemCreateLine(&m_gui,E_DRAW_LINE8,E_PG_SYSTEM_SETTINGS,10,125,240,125);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLACK,GSLC_COL_GRAY_LT2,GSLC_COL_GRAY_LT2);
  
  // create E_ELEM_DEL_DATA button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_DEL_DATA,E_PG_SYSTEM_SETTINGS,
  ...
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_PRINT_DATA,E_PG_SYSTEM_SETTINGS,
  ...
  // -----------------------------------
  // PAGE: E_PG_IOT_SETTINGS
  
  
  // Create E_ELEM_TEXT41 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT41,E_PG_IOT_SETTINGS,(gslc_tsRect){0,0,320,30},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT42,E_PG_IOT_SETTINGS,(gslc_tsRect){10,30,230,23},
  ...
  pElemRef = gslc_ElemCreateLine(&m_gui,E_DRAW_LINE6,E_PG_IOT_SETTINGS,10,55,240,55);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLACK,GSLC_COL_GRAY_LT2,GSLC_COL_GRAY_LT2);
  
  // Create E_ELEM_TEXT43 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT43,E_PG_IOT_SETTINGS,(gslc_tsRect){10,60,103,15},
    (char*)"Measure interval:",0,E_BUILTIN5X8);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_BOT_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  gslc_ElemSetTxtEnc(&m_gui,pElemRef,GSLC_TXT_ENC_UTF8);
  m_pElem_label_measure_art38_39_43 = pElemRef;
  
  // Create E_ELEM_MEAS_INTERVAL numeric input field
  static char m_sInputNumber2[3] = "1";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_MEAS_INTERVAL,E_PG_IOT_SETTINGS,(gslc_tsRect){120,60,27,15},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT44,E_PG_IOT_SETTINGS,(gslc_tsRect){150,60,25,15},
    (char*)"min.",0,E_BUILTIN5X8);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_BOT_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_BACK38 button with image label
  pElemRef = gslc_ElemCreateBtnImg(&m_gui,E_ELEM_BACK38,E_PG_IOT_SETTINGS,(gslc_tsRect){2,205,32,32},
          gslc_GetImageFromFile(IMG_EXIT,GSLC_IMGREF_FMT_BMP24),
          gslc_GetImageFromFile(IMG_EXIT,GSLC_IMGREF_FMT_BMP24),
          &CbBtnCommon);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  m_pElem_btn_back_main_38 = pElemRef;
